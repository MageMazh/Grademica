      ...
      <IonSplitPane className="split-pane" when="xs" contentId="main">
        ...
        <div className="ion-page" id="main">
          <IonContent className="dashboard ion-padding">
                  ...
                  <IonCol>
                    <IonCard className="dashboard-card">
                      <div className="dashboard-card__background-icon">
                        <IonIcon className="dashboard-card__icon" icon={card.icon}></IonIcon>
                      </div>
            ...
            <IonCard className="dashboard-card">
              <IonCardTitle className="dashboard-card__information">Informasi</IonCardTitle>
              <IonCardContent>
                <ol className="dashboard-card__list-information">
                  <li>Dikarenakan sistem informasi ini masih dalam proses pengembangan maka kami memohon maaf jika terdapat kekurangan yang menyebabkan kekurangan nyaman anda. </li>
                  <li>Diharapkan dapat menginput nilai seluruh mata kuliah sebelum batas penginputan nilai.</li>
                </ol>
              </IonCardContent>
            </IonCard>
          </IonContent>
